...
describe.each([
    { _modelClass: "Car", _model: "class Car inherits Vehicle attribute tipo int class Vehicle", _operation: "ADD efferent inherit", _direction: Direction.EFFERENT, _relationType: RelationType.INHERIT, _expected: "@startuml class Car { } @enduml" },    
