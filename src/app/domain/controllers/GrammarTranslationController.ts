            ...
            .removeClass("Z") */
               .addClass("A2")
                 ...
                 // .coupling(Direction.EFFERENT, RelationType.ASSOCIATION)
                  .withCoupling(new Axis(Direction.EFFERENT, RelationType.ALL))
                  .withoutCoupling(new Axis(Direction.EFFERENT, RelationType.ASSOCIATION))
              //    .withCoupling(new Axis(Direction.EFFERENT, RelationType.COMPOSITION))
                //  .withCoupling(new Axis(Direction.EFFERENT, RelationType.ALL))
