...
var deflater = window.SharedWorker && new SharedWorker('assets/scripts/jquery_plantuml/rawdeflate.js');
if (deflater) {
  deflater.port.addEventListener('message', done_deflating, false);
  deflater.port.start();
} else if (window.Worker) {
  deflater = new Worker('assets/scripts/jquery_plantuml/rawdeflate.js');
